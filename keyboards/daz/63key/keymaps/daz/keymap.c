...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(_FN), KC_SPC, KC_RSFT, KC_RALT, TT(_FN), KC_RCTL, KC_BSPC, KC_NUHS),
	...
	[_FN] = KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_RESET), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
